    ...
    <div className="space-y-8">
      <header className="rounded-3xl bg-white/80 p-8 shadow-lg backdrop-blur">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="uppercase tracking-[0.4em] text-slate-400">Warrior Camp</p>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-4 rounded-3xl bg-white/70 p-6 shadow-lg backdrop-blur">
